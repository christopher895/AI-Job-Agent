...
TECTONIC_PATH=/opt/homebrew/bin/tectonic   # path to tectonic binary
ALLOW_HTML_PDF_FALLBACK=false              # set true to use Playwright fallback if tectonic unavailable
```
...
**No auth** — Single user, private Railway URL. Clerk/NextAuth adds overhead with zero security benefit in this setup.
